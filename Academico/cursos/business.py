...
class CursoBusiness(ModelInstanceBusiness):
    ...
    def criar_curso(self, nome: str, codigo_curso: str, **kwargs):
        ...
        regras = CursoRules()
        regras.codigo_unico(codigo_curso)
        try:
    ...
    def atualizar_dados(self, dados: dict):
        ...
        if 'codigo_curso' in dados:
            regras = CursoRules(object_instance=self.object_instance)
            regras.codigo_unico(dados['codigo_curso'], excluir_id=self.object_instance.pk)
        try:
