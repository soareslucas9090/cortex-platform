...
### Transporte _(implementado — rotas, motoristas, tickets e embarque)_

Cadastro administrativo de percursos, rotas e execuções; alunos elegíveis podem
reservar tickets, acompanhar a fila PcD/FIFO e apresentar justificativas. Motoristas
ativos consultam as rotas do dia com status da execução e ocupação reais.
