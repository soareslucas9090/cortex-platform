...
def inserir_funcoes_raizes(apps, schema_editor):
    ...
    funcoes = [
        ...
        {"papel_funcao": "Coodernador de Apoio ao Ensino", "descricao": "Apoia atividades pedagógicas e assistência acadêmica.", "ativo": True},
        ...
        {"papel_funcao": "Coodernador NAPNE", "descricao": "Promove inclusão e acessibilidade educacional.", "ativo": True},
        {"papel_funcao": "Coodernador de Integração, Estágios, Egressos e Emprego", "descricao": "Coordena estágios e acompanhamento de egressos.", "ativo": True},
        {"papel_funcao": "Coordenador da Biblioteca", "descricao": "Gerencia serviços bibliográficos e acervo.", "ativo": True},
        {"papel_funcao": "Coodernador de Ensino Técnico", "descricao": "Coordena cursos técnicos do campus.", "ativo": True},
        {"papel_funcao": "Coodernador de Ensino Superior", "descricao": "Coordena os cursos superiores do campus.", "ativo": True},
...
def remover_funcoes_raizes(apps, schema_editor):
    ...
    papeis_funcao = [
        ...
        "Coodernador de Apoio ao Ensino", "Coordenador de Controle Acadêmico",
        "Coordenador de Disciplina", "Coodernador NAPNE",
        "Coodernador de Integração, Estágios, Egressos e Emprego", "Coordenador da Biblioteca",
        "Coodernador de Ensino Técnico", "Coodernador de Ensino Superior",
