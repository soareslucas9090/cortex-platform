...
- Verificar se viola algum padrão do `copilot-instructions.md` (ex: query ORM na view, hook retornando `Response` diretamente, exceção exposta ao cliente)
...
- Seguir os padrões da arquitetura (ver `copilot-instructions.md`):
