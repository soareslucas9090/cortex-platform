...
Revisar arquivos Python do projeto verificando conformidade com os padrões arquiteturais definidos no `copilot-instructions.md`. O revisor **aponta problemas, explica o padrão correto e sugere o código corrigido**.
